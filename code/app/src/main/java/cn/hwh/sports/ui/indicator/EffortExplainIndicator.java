...
package cn.hwh.sports.ui.indicator;
 ...
 * Viewpager 示意点
 */
public class EffortExplainIndicator extends View implements PageIndicator {
    ...
    public EffortExplainIndicator(Context context) {
        this(context, null);
    }

    public EffortExplainIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.circlePageIndicatorStyle);
    }

    public EffortExplainIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CirclePageIndicator, defStyle, R.style.CirclePageIndicator);
...
//        mPaintNormal.setStyle(Style.FILL);
        mPaintNormal.setColor(Color.parseColor("#777777"));
//        mPaintNormal.setColor(a.getColor(R.styleable.CirclePageIndicator_strokeColor, defaultStrokeColor));
        mPaintNormal.setStrokeWidth(a.getDimension(R.styleable.CirclePageIndicator_strokeWidth, defaultStrokeWidth));

        mPaintFill = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaintFill.setStyle(Style.FILL);
//        mPaintFill.setColor(a.getColor(R.styleable.CirclePageIndicator_fillColor, defaultFillColor));
        mPaintFill.setColor(Color.parseColor("#ff4612"));
