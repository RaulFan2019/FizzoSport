...
public class CircleProgressView extends View {
	...
	public CircleProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		if (attrs != null) {
			...
			for (int i = 0; i < count; i++) {
				...
				switch (attr) {
					case R.styleable.CircleProgress_radiusProgress:
						mRadius = ta.getDimension(R.styleable.CircleProgress_radiusProgress, mRadius);
						break;
					case R.styleable.CircleProgress_strokeWidthProgress:
						mStrokeWidth = ta.getDimension(R.styleable.CircleProgress_strokeWidthProgress, mStrokeWidth);
						break;
					case R.styleable.CircleProgress_bgColorProgress:
						bgColor = ta.getColor(R.styleable.CircleProgress_bgColorProgress, bgColor);
						break;
					...
					// textColor =
					// ta.getColor(R.styleable.CircleProgress_android_textColor,
					// textColor);
					// break;
				}
			}
	...
	protected void onDraw(Canvas canvas) {
		...
		// 绘制字体
		// canvas.drawText(mProgress + "%", mWidth / 2, mHeight / 2,
		// mPaintText);
		if (mPressed) {
