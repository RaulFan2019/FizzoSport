...
public class XmlParserHandler extends DefaultHandler {
	 ...
	 * 存储所有的解析对象
	 */
	private ArrayList<MELocation> provinceList = new ArrayList<MELocation>();

	public XmlParserHandler() {

	}

	public ArrayList<MELocation> getProvinceDataList() {
		return provinceList;
	}
	...
	MELocation provinceBean = new MELocation();
	String cityName = "";
